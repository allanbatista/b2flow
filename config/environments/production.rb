Rails.application.configure do
  ...
  config.public_file_server.enabled = AppConfig.B2FLOW__STORAGE__TYPE == "local" #ENV['RAILS_SERVE_STATIC_FILES'].present?
  ...
  config.active_storage.service = AppConfig.B2FLOW__STORAGE__TYPE
  ...
  # config.active_job.queue_name_prefix = "b2flow_api_production"
